...
#define STATE_SHORTCUT_RANDOM_LOW     STATE_SHORTCUT_RANDOM_PARAM + 1
#define STATE_SHORTCUT_RANDOM_SPAN    STATE_SHORTCUT_RANDOM_LOW + 1
#define STATE_SHORTCUT_TRANSPOSE      STATE_SHORTCUT_RANDOM_SPAN +1
