...
#define MENU_TRANSPOSE    MENU_RANDOM +1
#define MENU_PATTERN_CHAIN MENU_TRANSPOSE + 1
#define MENU_TUNER        MENU_PATTERN_CHAIN + 1
#define MENU_FILL         MENU_TUNER + 1
#define MENU_SKIP         MENU_FILL + 1
#define MENU_CLKDIV       MENU_SKIP + 1
#define MENU_RESET        MENU_CLKDIV + 1
#define MENU_REVERSE      MENU_RESET + 1
#define MENU_CHAIN_HELP   MENU_REVERSE + 1
#define MENU_PAGE         MENU_CHAIN_HELP + 1
#define MENU_FN1          MENU_PAGE + 1
#define MENU_FN2          MENU_FN1 + 1
#define MENU_FN3          MENU_FN2 + 1
#define MENU_FN4          MENU_FN3 + 1
...
#define STATE_PLAYMODE          STATE_BEATCOUNT +1

#define STATE_SWING           STATE_PLAYMODE +1
...
// MOD MENU 1
#define STATE_SKIPSTEPCOUNT   STATE_QUANTIZEMODE + 1
#define STATE_SKIPSTEP        STATE_SKIPSTEPCOUNT +1
#define STATE_GATEMUTE       255
#define STATE_GATEMOD       STATE_SKIPSTEP +1
#define STATE_RANDOMPITCH      STATE_GATEMOD +1
...
#define STATE_SHORTCUT_RANDOM_PARAM   STATE_INPUTDEBUG +1
#define STATE_SHORTCUT_RANDOM_VAR1     STATE_SHORTCUT_RANDOM_PARAM + 1
#define STATE_SHORTCUT_RANDOM_VAR2    STATE_SHORTCUT_RANDOM_VAR1 + 1
#define STATE_SHORTCUT_RANDOM_VAR3    STATE_SHORTCUT_RANDOM_VAR2 + 1
#define STATE_SHORTCUT_TRANSPOSE      STATE_SHORTCUT_RANDOM_VAR3 +1
#define STATE_SHORTCUT_FILL           STATE_SHORTCUT_TRANSPOSE +1
#define STATE_SHORTCUT_CLKDIV         STATE_SHORTCUT_FILL +1
#define STATE_SHORTCUT_SKIP           STATE_SHORTCUT_CLKDIV +1
#define STATE_SHORTCUT_SKIP_TRIGGER   STATE_SHORTCUT_SKIP +1
#define STATE_SHORTCUT_TUNER          STATE_SHORTCUT_SKIP_TRIGGER +1
#define STATE_SHORTCUT_PAGE           STATE_SHORTCUT_TUNER +1
#define STATE_SHORTCUT_FN1            STATE_SHORTCUT_PAGE +1
#define STATE_SHORTCUT_FN2            STATE_SHORTCUT_FN1 +1
#define STATE_SHORTCUT_FN3            STATE_SHORTCUT_FN2 +1
#define STATE_SHORTCUT_FN4            STATE_SHORTCUT_FN3 +1

//GLOBAL MENU
#define STATE_PG_BTN_SWITCH       STATE_SHORTCUT_FN4 + 1
...
#define STATE_MIDI_CHANNEL_1      STATE_CH4_VOLT_RANGE + 1
#define STATE_MIDI_CHANNEL_2      STATE_MIDI_CHANNEL_1 + 1
#define STATE_MIDI_CHANNEL_3      STATE_MIDI_CHANNEL_2 + 1
#define STATE_MIDI_CHANNEL_4      STATE_MIDI_CHANNEL_3 + 1
...
#define STATE_CHAIN_HELP    STATE_PATTERN_CHAIN +1

//SAVE MENU
#define STATE_SAVE               STATE_CHAIN_HELP +1
...
#define RANDOMIZE_PARAM_PITCHGATE    0
#define RANDOMIZE_PARAM_PITCH        RANDOMIZE_PARAM_PITCHGATE + 1
#define RANDOMIZE_PARAM_GATE         RANDOMIZE_PARAM_PITCH + 1
#define RANDOMIZE_PARAM_CV2_TYPE         RANDOMIZE_PARAM_GATE + 1
#define RANDOMIZE_PARAM_CV2_SPEED         RANDOMIZE_PARAM_CV2_TYPE + 1
#define RANDOMIZE_PARAM_CV2_AMPLITUDE     RANDOMIZE_PARAM_CV2_SPEED + 1
#define RANDOMIZE_PARAM_CV2_OFFSET        RANDOMIZE_PARAM_CV2_AMPLITUDE + 1
// #define RANDOMIZE_PARAM_CV2_ENV         RANDOMIZE_PARAM_CV2_SPEED + 1
